...
ukb_eqtl_mr = rbind(uvmr(exp_name = "F2R ukb str", out_name = kidney_outcomes[kidney_outcomes %notin% c("ns_meta","ukb-d-30600_irnt","ma")]),
...
ukb_eqtl_mr_ld = rbind(uvmr_cor(exp_name = "F2R ukb wk", out_name = kidney_outcomes[kidney_outcomes %notin% c("ns_meta","ukb-d-30600_irnt","ma")]),
